...
const directoryPath = './dist/test-angular/'; // Replace with your directory path
const outputFilePath = './dist/test-angular/test-angular.js'; // Replace with your desired output file path
